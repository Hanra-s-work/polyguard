...
-- LAST Modified: 10:54:46 13-03-2026
-- DESCRIPTION:
-- A module that provides a set of swearwords to listen to when filtering while allowing to toggle on and off different languages.
-- /STOP
-- COPYRIGHT: (c) Henry Letellier
-- PURPOSE: This is the code of conduct for the module.
-- // AR
-- +==== END polyguard =================+
-->

# Backend Server Repository Code of Conduct**
...
We are committed to making participation in the Backend Server repository a positive experience for all contributors. By participating in this project, you agree to abide by the following standards of behavior.
...
The maintainers of the Backend Serverrepository reserve the right to take appropriate action if any part of this Code of Conduct is violated. This may include:
...
Thank you for helping make the Backend Serverrepository a positive and inclusive environment for all!
